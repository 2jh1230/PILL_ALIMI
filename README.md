업로드하신 코드와 프로젝트 구조를 바탕으로, 깃허브 메인 화면에 띄울 **README.md** 파일을 작성해 드립니다.

이 내용은 프로젝트의 \*\*핵심 기능(AI 스캔, 약국 찾기 등)\*\*과 **기술 스택**, 그리고 가장 중요한 **환경 변수 설정 방법**을 포함하고 있습니다. 아래 내용을 복사해서 프로젝트 최상위 폴더에 `README.md` 파일을 만들고 붙여넣으시면 됩니다.
